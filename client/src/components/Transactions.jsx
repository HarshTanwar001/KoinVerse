...
const TransactionCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount, url }) => {
    ...
    return(
        <div className='bg-[#181918] m-4 flex flex-1 2xl:min-w-[450px] 2xl:max-w-[550px] sm:min-w-[270px] sm:max-w-[300px] flex-col p-3 rounded-md hover:shadow-2xl'>
        ...
        <div className='flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions'>
            <div className='flex flex-col md:p-12 py-12 px-4'>
                {currentAccount ? (
                    ...
                    <h3 className='text-white text-3xl text-center my-2'>Connect your account to get the latest transactions</h3>
